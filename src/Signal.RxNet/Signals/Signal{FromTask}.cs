...
#pragma warning restore IDE0042 // Deconstruct variable declaration
    ...
    internal static IDisposable DisposeWith(this IDisposable disposable, CompositeDisposable container)
    {
...
#pragma warning restore SA1009 // Closing parenthesis must be spaced correctly
    {
        ...
        var readyTask = await Task.WhenAny(asyncTask, cancellationTask).ConfigureAwait(true);
        ...
        {
            await asyncTask.ContinueWith(_ => asyncTask.Exception, cancellationToken, TaskContinuationOptions.OnlyOnFaulted | TaskContinuationOptions.ExecuteSynchronously, TaskScheduler.Current).ConfigureAwait(false);
        }
